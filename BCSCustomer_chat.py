...
def main():
    load_dotenv()
    st.set_page_config(page_title="BCS Customer Chat", page_icon=".")
    ...
    sample_pdf_path = os.path.join(os.getcwd(), "¿Qué es BCS AI.pdf")
    ...
    st.write("<h5><br>Pregunte lo que necesite sobre BCS (Business Core Software), no importa el idioma, somos multiculturales!:</h5>", unsafe_allow_html=True)
    ...
    whatsapp_message = "Quiero más info acerca de BCS"
